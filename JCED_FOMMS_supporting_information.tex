...
\begin{table}[htb!]
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|c|}
			...
			370 & $440.86_{0.43}$ & $51.3_{1.3}$ & $1.8856_{8.8e-3}$ & $13.31_{0.11}$ & $0.695_{0.015}$ \\
			360 & $460.16_{0.83}$ & $40.72_{0.64}$ & $1.5515_{4.8e-3}$ & $14.524_{0.080}$ & $0.740_{0.011}$ \\
			350 & $477.25_{0.86}$ & $32.43_{0.28}$ & $1.2638_{3.8e-3}$ & $15.559_{0.056}$ & $0.78_{0.01}$ \\
			340 & $492.86_{0.74}$ & $25.78_{0.16}$ & $1.0177_{3.4e-3}$ & $16.473_{0.048}$ & $0.81_{0.01}$ \\
			330 & $507.34_{0.80}$ & $20.38_{0.14}$ & $0.8090_{3.3e-3}$ & $17.292_{0.053}$ & $0.84_{0.01}$ \\
			320 & $521.13_{0.61}$ & $15.97_{0.11}$ & $0.6336_{3.4e-3}$ & $18.042_{0.053}$ & $0.87_{0.01}$ \\
			310 & $534.54_{0.29}$ & $12.374_{0.074}$ & $0.4881_{3.6e-3}$ & $18.745_{0.042}$ & $0.89_{0.01}$ \\
			300 & $547.12_{0.22}$ & $9.452_{0.060}$ & $0.3690_{3.5e-3}$ & $19.389_{0.035}$ & $0.910_{0.010}$ \\
			290 & $558.97_{0.19}$ & $7.101_{0.076}$ & $0.2732_{3.2e-3}$ & $19.980_{0.039}$ & $0.927_{0.012}$ \\
			280 & $570.80_{0.34}$ & $5.230_{0.094}$ & $0.1975_{2.7e-3}$ & $20.552_{0.048}$ & $0.943_{0.019}$ \\
			270 & $582.96_{0.45}$ & $3.76_{0.10}$ & $0.1389_{2.5e-3}$ & $21.122_{0.071}$ & $0.956_{0.034}$ \\
			260 & $593.85_{0.25}$ & $2.63_{0.10}$ & $0.0946_{2.7e-3}$ & $21.62_{0.12}$ & $0.966_{0.060}$ \\
			250 & $603.32_{0.94}$ & $1.787_{0.089}$ & $0.0623_{3.4e-3}$ & $22.06_{0.24}$ & $0.97_{0.10}$ \\
			\hline
		\end{tabular}
	\end{center}
\end{table}
