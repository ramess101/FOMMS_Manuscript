...
\section{Compressibility factor} \label{SI sec: Z}
	...
	\begin{figure}[htb!]
		\centering
		\includegraphics[width=3.2in]{Compressibility_factor.pdf}
		\caption{Compressibility factor in saturated vapor phase $(Z^{\rm sat}_{\rm vap})$ for all compounds simulated in Mick et al. and Soroush Barhaghi et al.}
		\label{SI fig:Z}
	\end{figure}
...
\section{Tabulated $\psi$ values} \label{SI sec: eps scale}
...
\begin{table}[htb!]
	\caption{State points simulated for cyclohexane with the TraPPE force field $(\theta^{\langle0\rangle})$.}
	\begin{center}
		\begin{tabular}{|c|c|c|}
			\hline
			$T$ (K) & $\mu$ (K) & $L$ (nm) \\ \hline
