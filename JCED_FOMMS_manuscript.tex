...
%%% Included alkyne parameters
    \begin{table}[h!]
		\caption{Equilibrium bond angles $(\theta_{\rm eq})$ and force constants $(k_\theta/k_{\rm B})$, where $k_{\rm B}$ is the Boltzmann constant \cite{Martin1999,Nath2001,Potoff_branched,Barhaghi2017}. CH$_x$ and CH$_y$ represent CH$_3$, CH$_2$, CH, or C sites.} \label{tab:angles}
		\begin{center}
    ...
    \begin{table}[h!]
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|}
				...
				CH$_x$-CH$_2$-C-CH$_y$ & 0.0 & 0.0 & 0.0 & 461.29 \\
				CH$_x$-CH-CH-CH$_y$ & -251.06 & 428.73 & -111.85 & 441.27 \\
				CH$_x$-CH$_2$-$CH_2$-C(sp) & 94.88 & 162.00 & -205.40 & 980.40 \\
