...
\subsection{Force fields} \label{sec: Force fields}
    ...
    For computational efficiency, we utilize fixed bond lengths for each force field. Note that the original NERD publications utilized a harmonic bond potential \cite{NERD}. The bond lengths for all bonds, compounds, and force fields investigated in this study are reported in Table \ref{tab:bonds}.
...
%RAM: I believe JCED wants these in the manuscript
%    \begin{table}[h!]
